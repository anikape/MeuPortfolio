...
const Projects = () => {
  return (
    ...
    <div className="projetos-cards">
      ...
      <h3>SouJr</h3>
      <a href="https://www.soujunior.tech/" target="_blank" rel="noreferrer" id="btn">Ver Projeto</a>
    </div>
    <div className="projetos-cards">
      <img src={Avatar} alt="Brasileirissimo" />
      <h3>Brasileiríssimo</h3>
      <a href="https://matheusxavierr.github.io/ProjetoDev/" target="_blank" rel="noreferrer" id="btn">Ver Projeto</a>
    </div>
    <div className="projetos-cards">
      <img src={SustentaTech} alt="Sustenta-Tech" />
      <h3>Sustena-Tech</h3>
      <a href="https://wellpt.github.io/TechTeamProject/" target="_blank" rel="noreferrer" id="btn">Ver Projeto</a>
    </div>
    ...
    <div className="projetos-cards">
      ...
      <h3></h3>
      <a href="https://anikape.github.io/MundoInvertido-DIO/" target="_blank"  rel="noreferrer"id="btn">Ver Projeto</a>
    </div>
    <div className="projetos-cards">
      <img src={NLW} alt="NLW" />
      <h3></h3>
      <a href="https://anikape.github.io/nlw-esports-explorer/" target="_blank" rel="noreferrer" id="btn">Ver Projeto</a>
    </div>
    <div className="projetos-cards">
      <img src={Conversor} alt="Conversor de Moedas" />
      <h3></h3>
      <a href="https://anikape.github.io/Conversor-de-Moedas/" target="_blank"  rel="noreferrer" id="btn">Ver Projeto</a>
    </div>
